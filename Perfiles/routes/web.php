...
//carreras
Route::get('inicio/carreras','CarreraController@index')->name('carreras');
Route::get('inicio/carreras/crear','CarreraController@crear')->name('crearCarrera');
Route::post('inicio/carreras/guardar','CarreraController@guardar')->name('guardarCarrera');
//Route::get('/carreras/{carrera}','CarreraController@detalle')->name('detalleCarrera');
Route::get('inicio/carreras/{carrera}/editar','CarreraController@editar')->name('editarCarrera');
Route::put('inicio/carreras/{carrera}','CarreraController@actualizar')->name('actualizarCarrera');//put metodo para actualizar
Route::delete('inicio/carreras/{carrera}/eliminar','CarreraController@eliminar')->name('eliminarCarrera');
Route::get('inicio/carreras/importar','CarreraController@importar')->name('importarCarreras');
Route::post('inicio/carreras/importacion','CarreraController@importacion')->name('importacionCarrera');
Route::any('inicio/carreras/agregarArea/{carrera}', 'CarreraController@areas')->name('areasCarrera');
Route::any('inicio/carreras/agregarArea/almacenar/{carrera}', 'CarreraController@almacenarArea')->name('almacenarAreasCarrera');
Route::any('inicio/carreras/eliminarArea/{carrera}/{area}', 'CarreraController@EliminarArea')->name('eliminarCarreraArea');

//Gestion
Route::any('inicio/gestion', 'GestionController@index')->name('gestiones');
Route::get('inicio/gestion/registrar', 'GestionController@registrar')->name('registrarGestion');
Route::any('inicio/gestion/registrar/almacenar', 'GestionController@almacenar')->name('almacenarGestion');
Route::get('inicio/gestion/editar/{gestion}', 'GestionController@editar')->name('editarGestion');
Route::post('inicio/gestion/editar/modificar/{gestion}', 'GestionController@modificar')->name('modificarGestion');
...
Route::get('docentes/cambiar_contraseña_docente/{docente}','docenteController@cambiarContraseña')->name('cambiarContraseñaDocente');
Route::post('docentes/guardar_contraseña_docente/{docente}','docenteController@guardarContraseña')->name('guardarContraseñaDocente');
Route::get('docentes/tutoria/{docente}','docenteController@tutoria')->name('tutoriaDocente');
Route::get('docentes/exportar_pdf_tutoria/{docente}','docenteController@descargarPdf')->name('tutoriaDocentePdf');
...
//reportes
Route::get('reportes/generar_reportes','ReportesController@generar')->name('generar')->middleware('permisos:reportes');
Route::post('reportes/generador/reportes','ReportesController@generador')->name('generador')->middleware('permisos:reportes');
Route::get('reportes/pdf','ReportesController@reporte')->name('reportePdf')->middleware('permisos:reportes');

Route::get('inicio/guiaFormulario','guiaController@index')->name('guiaFormulario');