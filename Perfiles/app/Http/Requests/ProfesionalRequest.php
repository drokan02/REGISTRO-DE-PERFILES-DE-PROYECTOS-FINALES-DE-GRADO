    ...
    public function rules()
    {
        ...
        if($ruta == 'almacenarProfesional'){
            ...
            return [
                ...
                'ap_pa_prof'  => ['required','alpha','min:3'],
                'ap_ma_prof'  => ['required','alpha','min:3'],
                'ci_prof'     => ['required','num','min:6','max:8',Rule::unique('profesionales', 'ci_prof')->ignore($this->{'id'})],
                'telef_prof'   => ['required','num','min:7','max:8',Rule::unique('profesionales', 'telef_prof')->ignore($this->{'id'})],
